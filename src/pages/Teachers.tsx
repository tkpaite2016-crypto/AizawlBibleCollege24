          ...
          <div className="page-container">
            {loading ? (
              ...
              <div className="faculty-list space-y-8">
                {filtered.map((member) => (
                  <div key={member.id} className="faculty-card card hover:shadow-lg transition-all duration-300 relative">
                    <div className="faculty-inner flex flex-col md:items-stretch">
                      {/* Photo */}
                      <div className="faculty-photo w-full md:w-56 lg:w-72 flex-shrink-0 bg-slate-100 relative overflow-hidden" style={{ minHeight: '220px' }}>
                        {member.photo_url ? (
                          <img
                            src={member.photo_url}
